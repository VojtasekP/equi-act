...
def adjust_channels(
    ...
    if layer_index > 1:
        ...
        if activation_type in ['fourier_relu', 'fourier_elu', 'norm_relu', 'normbn_relu', 'normbn_elu', 'normbn_sigmoid', 'normbnvec_relu', 'normbnvec_elu', 'normbnvec_sigmoid', 'norm_squash', 'non_equi_relu', 'fourierbn_elu', 'fourierbn_relu']:
